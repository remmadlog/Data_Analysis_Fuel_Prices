...
We still have **blank** city names, but for this case we can consider the postal code.
...
We get - `47929`, which is the postal code of **grefrath** - `97688`, which is the postal code of **bad kissingen** - `44357`, which is the postal code of **dortmund** - , wich we will remove
